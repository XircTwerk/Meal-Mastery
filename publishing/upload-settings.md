...
Four jars, one per branch/loader combination. All are version `1.0`.
...
|---|---|
| Branch | `1.20.1` |
| Jar | `fabric/build/libs/mealmastery-fabric-1.20.1-1.0.jar` |
| Minecraft version | 1.20.1 |
| Mod loader | Fabric |
| Java | 17 |
| Release channel | Release |
| Display name | Meal Mastery 1.0 — 1.20.1 Fabric |
...
|---|---|
| Branch | `1.20.1` |
| Jar | `forge/build/libs/mealmastery-forge-1.20.1-1.0.jar` |
| Minecraft version | 1.20.1 |
| Mod loader | Forge |
| Java | 17 |
| Release channel | Release |
| Display name | Meal Mastery 1.0 — 1.20.1 Forge |
...
|---|---|
| Branch | `1.21.1` |
| Jar | `fabric/build/libs/mealmastery-fabric-1.21.1-1.0.jar` |
| Minecraft version | 1.21.1 |
| Mod loader | Fabric |
| Java | 21 |
| Release channel | Release |
| Display name | Meal Mastery 1.0 — 1.21.1 Fabric |
...
|---|---|
| Branch | `1.21.1` |
| Jar | `neoforge/build/libs/mealmastery-neoforge-1.21.1-1.0.jar` |
| Minecraft version | 1.21.1 |
| Mod loader | NeoForge |
| Java | 21 |
| Release channel | Release |
| Display name | Meal Mastery 1.0 — 1.21.1 NeoForge |
