...
public final class WorkstationRegistry {
    ...
    private static Map<ResourceLocation, CookingMethod> defaults() {
        ...
        map.put(ResourceLocation.withDefaultNamespace("campfire"), CookingMethod.CAMPFIRE);
        map.put(ResourceLocation.withDefaultNamespace("soul_campfire"), CookingMethod.CAMPFIRE);
        return map;
    }
